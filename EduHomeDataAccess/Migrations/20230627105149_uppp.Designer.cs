...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduHome.Core.Entities.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduHome.Core.Entities.CompanySpeakers", b =>
                {
            ...
            modelBuilder.Entity("EduHome.Core.Entities.Upcomming", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduHome.Core.Entities.UpcommingCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduHome.Core.Entities.UpcommingDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduHome.Core.Entities.UpcommingSpeakers", b =>
                {
                    b.Property<int>("SpeakersId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("UpcommingSpeakers");
                });

            modelBuilder.Entity("EduHome.Core.Entities.CompanySpeakers", b =>
                {
                    b.HasOne("EduHome.Core.Entities.Company", "Company")
            ...
            modelBuilder.Entity("EduHome.Core.Entities.Upcomming", b =>
                {
                    b.HasOne("EduHome.Core.Entities.UpcommingCategory", "UpcommingCategory")
                        .WithMany("Upcommings")
            ...
            modelBuilder.Entity("EduHome.Core.Entities.UpcommingDetails", b =>
                {
                    b.HasOne("EduHome.Core.Entities.Upcomming", "Upcomming")
                        .WithOne("Details")
                        .HasForeignKey("EduHome.Core.Entities.UpcommingDetails", "UpcommingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
